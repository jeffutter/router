...
![Version: 2.14.0-rc.2](https://img.shields.io/badge/Version-2.14.0--rc.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v2.14.0-rc.2](https://img.shields.io/badge/AppVersion-v2.14.0--rc.2-informational?style=flat-square)
...
```console
helm pull oci://ghcr.io/apollographql/helm-charts/router --version 2.14.0-rc.2
```
...
```console
helm upgrade --install [RELEASE_NAME] oci://ghcr.io/apollographql/helm-charts/router --version 2.14.0-rc.2 --values my-values.yaml
```
